			...
			<section className="relative bg-dark-hard px-5">
				<div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
					<div className="col-span-12 lg:col-span-6">
						...
						<p className="text-dark-light md:text-center text-sm leading-7 mt-6">
							<span className="font-bold italic text-[#b3bac5] md:text-center md:text-base md:not-italic md:font-normal md:text-dark-light lg:text-left">
							...
							<div className="w-full rounded-xl bg-white p-3 z-[1] relative">
								...
								<div className="p-5">
									...
									<p className="text-dark-light mt-3 text-sm md:text-lg">
										...
										Nihil molestias sit magnam, repellat quae, necessitatibus.
									</p>
								</div>
							</div>
						</div>
